...
def generate_launch_description():
    ...
    #urdf_file_name = 'urdf/bravo7_dynamics_v2.urdf'
    urdf_file_name = 'urdf/bravo7_no_ee_v2_example_robot_data_collision_revolute.urdf'
    #urdf_file_name = 'urdf/bravo_7_noFT_pinocchio_dynamic.urdf'
