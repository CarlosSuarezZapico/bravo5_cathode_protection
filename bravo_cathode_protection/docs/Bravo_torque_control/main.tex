...
\title{Bravo 5: Cathode Protection}
...
\section{Neccesary Conditions for the arm}
\begin{itemize}
    \item Slip rings in continuous rotation joints to avoid cable twisting.
    \item Joint current control watchdog to prevent arm from going haywire if communication is lost.
\end{itemize}

\begin{figure*}[h!]
\begin{center}
     \includegraphics[width=0.7\linewidth]{images/IDE_terminal.png}
     \caption{Terminal graphical interface for the arm and CP application.}
     \label{fig:IDE_terminal}
\end{center}
\end{figure*}
