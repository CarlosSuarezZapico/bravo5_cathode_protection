...
int main(int argc, char ** argv)
{
        ...
        const std::string config_stiff_control_file = (package_path + "/config/stiff_control_params/bravo5_cp_compliance_fixed_axis.yaml");
        const std::string config_runtime_file       = (package_path + "/config/program_params/bravo5_cp_fixed_axis_runtime.yaml");
