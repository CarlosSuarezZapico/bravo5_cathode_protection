...
class Packets:
    ...
    def __init__(self):
        ...
        self.FORCETORQUE = PacketPrototype(PacketID.FORCETORQUE, data_type=float, data_comments=["FX", "FY", "FZ", "TX", "TY", "TZ"])
        self.LOCALVELOCITY = PacketPrototype(PacketID.LOCAL_VELOCITY, data_type=float, data_comments=["X", "Y", "Z", "Y", "P", "R"])
    ...
    FORCETORQUE = PacketPrototype(PacketID.FORCETORQUE, data_type=float, data_comments=["FX", "FY", "FZ", "TX", "TY", "TZ"])
