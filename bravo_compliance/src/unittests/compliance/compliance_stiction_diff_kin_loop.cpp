...
//epsilon Increase until the torque command stops buzzing when you hold position still.

//epsilon Too large will make stiction compensation weaker at very small errors.
